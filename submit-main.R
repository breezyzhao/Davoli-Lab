...
#################################################################################################### Fig4
##---Fig4 all data/plots from Caris
#################################################################################################### Fig5
##---Fig5 from Catherine Eng
#################################################################################################### FigS1
if(figS1==T){
  ##---FigS1A and B
  library(survival)
...
#################################################################################################### FigS3
##---FigS3 is based on Teresa's scripts
#################################################################################################### FigS4
if(figS4==T){
###---FigS4
library(ggstatsplot)
...
#################################################################################################### FigS8
##---FigS8 should be exact same with FigS7, using CD3D instead of CD8A
#################################################################################################### FigS9
if(figS9==T){
##---FigS9A from GSEA
##---FigS9B~E
